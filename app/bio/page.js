...
export default function Bio() {
  ...
  let filteredProducts = products.filter(p => p.category === "bio")
  if (sortPrice === "asc") filteredProducts.sort((a, b) => a.price - b.price)
  if (sortPrice === "desc") filteredProducts.sort((a, b) => b.price - a.price)

  return (
    <div className="p-8">
      <h1 className="text-3xl font-bold mb-6 text-center">Produits BIO</h1>
      <p className="text-center mb-8">Découvrez nos produits BIO.</p>
